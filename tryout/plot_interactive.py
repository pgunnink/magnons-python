...
class DoublePlot:
    ...
    def plot_E(self, Nlim=6, logplot=True):
...
with Data('data/main_data.h5') as f:
    kvalues, energies, ev, attrs = f.read_data(2)
db = DoublePlot(kvalues, energies, ev)
db.plot_E(Nlim=10, logplot=False)
plt.show()